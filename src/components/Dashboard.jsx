                    ...
                    <div id="content">
                        ...
                        <nav className="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                            ...
                            <ul className="navbar-nav ml-auto">
                                ...
                                <li className="nav-item dropdown no-arrow d-flex justify-content-center align-items-center">
                                    <div className='d-flex justify-content-center align-items-center'>
                                    <span className="mr-2 d-none d-lg-inline text-gray-600 small" onClick={() => {
                                        clearCookie("a_session_6325af9026717524dc78_legacy")
                                        clearCookie("email")
                                            ...
                                            <div className="row no-gutters align-items-center">
                                                <div className="col mr-2">
                                                    ...
                                                    <div className="h5 mb-0 font-weight-bold text-gray-800">
                                                        {/* <a href="#">Start <i className="fa fa-fw fa-arrow-right"></i></a> */}
                                        ...
                                        <div className="card-body">
                                            <div className="row no-gutters align-items-center">
                                                <div className="col mr-2">
                                                    ...
                                                    <div className="h5 mb-0 font-weight-bold text-gray-800">
                                                        {/* <a href="#">Start  <i className="fa fa-fw fa-arrow-right"></i></a> */}
                                                        <CreateProject type={'hardware'} email={id}/>
                                                    </div>
                                                </div>
                                                <div className="col-auto">
                                                    <i className="fa fa-calendar fa-2x text-gray-300"></i>
